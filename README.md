...
| Overview | Projects |
|---|---|
| ![Overview](screenshot-overview.png) | ![Projects](screenshot-projects.png) |

| Overview (中文) | Projects (中文) |
|---|---|
| ![概览](screenshot-overview-zh.png) | ![项目管理](screenshot-projects-zh.png) |
...
| `/api/shutdown` | POST | Shutdown the dashboard server |
...
│   └── aggregate.py         # Data aggregation (Python)
...
├── start-silent.bat         # Windows silent launcher (for Task Scheduler)
...
├── start-silent.bat         # Windows 静默启动（任务计划程序用）
